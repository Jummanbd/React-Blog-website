...
import smallimg02 from '../../assets/images/hero-5.jpg';
...
const Singleone = () => {
  ...
  return (
    <main>
     <GeneralHeader/>
    <section className="section--padding singleone-area">
        <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-wrap">
            <span className="badge">Jewelry</span>
            <div className="heading-section text-start single-heading mb-4">
            ...
            <div className="singleone-wrapper">
                <Singleuser usersImag={smallimg} userTitle={"Foulcher Nothanil"} postdate={"May 20.2024"}/>
        ...
        <div className="row">
          <div className="col-lg-12">
            <img src={herobg}  alt="img" className="singleone-bg-img" />
        ...
        <div className="singleone--wrapper">
          ...
          <div className="singleone-second-wrap">
            ...
            <img src={smallimg02} alt="img"className="my-4 small-img"  />
            <p className="py-4">
...
{/* --------------------Modal------------------------ */}
    <Modal show={hide} onHide={handleClose} className="hide-model-area">
